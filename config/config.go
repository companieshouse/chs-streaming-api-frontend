...
type Config struct {
	...
	CertFile             string `env:"CERT_FILE"                    flag:"cert-file"              flagDesc:"Certificate file" json:"-"`
	KeyFile              string `env:"KEY_FILE"                     flag:"key-file"               flagDesc:"Key file" json:"-"`
	EricURL              string `env:"ERIC_LOCAL_URL"               flag:"eric-url"               flagDesc:"Eric url" json:"-"`
	...
	CacheBrokerURL       string `env:"CACHE_BROKER_URL"             flag:"cache-broker-url"       flagDesc:"Cache broker url" json:"-"`
	...
	ApiKey               string `env:"CHS_API_KEY" flag:"api-key" flagDesc:"API key used to connect to cache service" json:"-"`
}
